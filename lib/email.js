 ...
 */
async function sendCardEmail(data, smtpConfig = {}) {
  ...
  try {
    ...
    const from = smtpConfig.from || process.env.SMTP_FROM || process.env.SMTP_USER;
    const siteName = smtpConfig.fromName || data.siteName || '甜甜发卡';
